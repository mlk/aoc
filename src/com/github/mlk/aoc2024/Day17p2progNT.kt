...
suspend fun main() {
    //coroutineScope {
        ...
        val totalChecks = (8.0.pow(16).toLong() - 8.0.pow(15).toLong())

        var checks = 0L
        val showPercentage = totalChecks / 100_000



        println("Start Up")
        //for(startA in 62761524L..62777524L step 8 ) {
        for (startA in 8.0.pow(15).toLong() + 2..8.0.pow(16).toLong()) {
